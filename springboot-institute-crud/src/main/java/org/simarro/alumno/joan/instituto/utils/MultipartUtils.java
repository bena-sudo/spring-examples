package org.simarro.alumno.joan.instituto.utils;
...
/**
 * Utilidad para manejar archivos {@link MultipartFile} en aplicaciones Spring
 * Boot.
 * 
 * <p>
 * Proporciona métodos para convertir archivos multipart en bytes, extraer su
 * extensión
 * y codificarlos en Base64.
 * </p>
 * 
 * <p>
 * Si se detectan errores en la manipulación de los archivos, se lanza una
 * excepción
...
public class MultipartUtils {
     ...
     * @throws MultipartProcessingException si el archivo es nulo, está vacío o no
     *                                      se puede leer.
     */
     ...
     * @throws MultipartProcessingException si el archivo es nulo, su nombre es nulo
     *                                      o no tiene extensión válida.
     */
     ...
     * 
     * @param file el archivo multipart a convertir.
     * @return una cadena que representa el contenido del archivo codificado en
     *         Base64.
     * @throws MultipartProcessingException si el archivo es nulo, está vacío o no
     *                                      se puede leer.
     */
