...
public class DocAlumnoController {
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "OK: Archivo devuelto con éxito para previsualización", content = @Content(mediaType = "application/octet-stream", // Esto
                                                                                                                                                                                            // es
                                                                                                                                                                                            // un
                                                                                                                                                                                            // ejemplo,
                                                                                                                                                                                            // el
                                                                                                                                                                                            ...
                                                                                                                                                                                            // el
                                                                                                                                                                                            // archivo
                                        schema = @Schema(type = "string", format = "binary") // Indica que se trata de
                                                                                             // datos binarios
                        )),
                        @ApiResponse(responseCode = "400", description = "Bad Request: Error de validación en el ID proporcionado (errorCode:'ID_FORMAT_INVALID')", content = {
                                        @Content(mediaType = "application/json", schema = @Schema(implementation = CustomErrorResponse.class)) }),
        ...
        @ApiResponses({
                        @ApiResponse(responseCode = "200", description = "Lista agrupada de documentos por nickname", content = {
                                        @Content(mediaType = "application/json", schema = @Schema(type = "array", implementation = DocAlumnoCountByNicknameResponse.class))
                        })
        })
