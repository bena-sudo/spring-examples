...
import edu.alumno.joan.api_rest_bd_futbol.exception.CustomErrorResponse;
...
import edu.alumno.joan.api_rest_bd_futbol.srv.JugadorService;
...
public class JugadorRestController {
   ...
   *
   * @param jugadorService Servicio que maneja la lógica de negocio de los
   *                       jugadores.
   */
  ...
  @ApiResponses({
      @ApiResponse(responseCode = "200", description = "Lista de jugadores obtenida correctamente", content = {
  ...
  /**
   * Obtiene una lista paginada de jugadores mediante una solicitud POST con un
   * objeto de filtros.
   *
