...
public class FiltroBusquedaHelper {
     ...
     * Detecta el operador (>, <, :) automáticamente y maneja valores que contienen
     * el operador.
     *
     * @param filtros Array de cadenas en formato "atributo>valor",
    ...
    public static List<FiltroBusqueda> createFiltroBusqueda(String[] filtros) {
        ...
        for (String filtro : filtros) { // Detectar el operador basado en el orden de prioridad
            int posOperador = -1;
            TipoOperacionBusqueda operador = null;

            if ((posOperador = filtro.indexOf(">")) != -1) {
                operador = operador.deSimbolo(">");
            ...
            // Extraer el atributo (todo antes del operador) y el valor (todo después del
            // operador)
